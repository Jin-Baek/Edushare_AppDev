...
public class A_Article_DBread {
	 private static A_Article_DBread article_dbread = new A_Article_DBread();

	   public static A_Article_DBread getBoard() {
	   ...
	   public ArrayList<ArticleVO> select() {
		   ...
		   try {
			...
			conn = DriverManager.getConnection(url,userId,userPw);
	         ...
	         sql = "SELECT * FROM CATEGORY_ARTICLE WHERE CATEGORY_NAME='A' ORDER BY ARTICLE_NUM ";
