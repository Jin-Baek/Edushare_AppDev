...
public class B_Article_DBread {
	 private static B_Article_DBread article_dbread = new B_Article_DBread();

	   public static B_Article_DBread getBoard() {
	   ...
	   public ArrayList<ArticleVO> select() {
		   ...
		   try {
			...
			conn = DriverManager.getConnection(url,userId,userPw);
	         ...
	         sql = "SELECT * FROM CATEGORY_ARTICLE WHERE CATEGORY_NAME='B' ORDER BY ARTICLE_NUM ";
